...
|===
| ID | 2+| WHEN | 2+| THEN
h| |h|[background-color="#e6ffe6"]#\#has birthday#|h|[background-color="#ffffe0"]#Customer.age#|h|[background-color="#e0ffff"]#Discount add: "birthday" withPercent:#|h|[background-color="#ffe6e6"]#\#offerCar#
| BIRTHDAY_DISCOUNT |[background-color="#e6ffe6"]#*#| |[background-color="#e0ffff"]#15#|
| BD_CAR_OFFER |[background-color="#e6ffe6"]#*#|[background-color="#ffffe0"]#>= 18#||[background-color="#ffe6e6"]#"blue"#
|===
