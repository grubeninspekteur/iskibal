...
/**
 * Parser interface for parsing Iskara rule sources into a {@link RuleModule}.
 * <p>
...
public interface Parser {
    ...
    /**
     * Parses the given source code into a {@link RuleModule}.
     *
     * @param source the source code to parse
     * @param options parsing options
     * @return the parse result, either success with a RuleModule or failure with errors
     */
     ...
     * @throws IllegalStateException if no parser implementation is found
     */
    static Parser load() {
