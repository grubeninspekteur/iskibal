...
public class ExpressionVisitor extends IskaraParserBaseVisitor<Expression> {
    ...
    public Expression visitUnaryMinusExpr(IskaraParser.UnaryMinusExprContext ctx) {
        ...
        return new Binary(
                new Literal.NumberLiteral(BigDecimal.ZERO),
    ...
    private Binary.Operator mapComparisonOp(IskaraParser.ComparisonOpContext ctx) {
        if (ctx.EQUALS() != null) return Binary.Operator.EQUALS;
        if (ctx.NOT_EQUALS() != null) return Binary.Operator.NOT_EQUALS;
        if (ctx.GREATER() != null) return Binary.Operator.GREATER_THAN;
        if (ctx.LESS() != null) return Binary.Operator.LESS_THAN;
        if (ctx.GREATER_EQ() != null) return Binary.Operator.GREATER_EQUALS;
        if (ctx.LESS_EQ() != null) return Binary.Operator.LESS_EQUALS;
        return Binary.Operator.EQUALS;
    }

    private Binary.Operator mapAdditiveOp(IskaraParser.AdditiveOpContext ctx) {
        if (ctx.PLUS() != null) return Binary.Operator.PLUS;
        if (ctx.MINUS() != null) return Binary.Operator.MINUS;
        return Binary.Operator.PLUS;
    }

    private Binary.Operator mapMultiplicativeOp(IskaraParser.MultiplicativeOpContext ctx) {
        if (ctx.STAR() != null) return Binary.Operator.MULTIPLY;
        if (ctx.SLASH() != null) return Binary.Operator.DIVIDE;
