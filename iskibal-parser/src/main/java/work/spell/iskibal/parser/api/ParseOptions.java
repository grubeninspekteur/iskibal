 ...
 *
 * @param locale the locale to use for parsing numbers (determines decimal separator)
 * @param sourceType the type of source being parsed
 * @param sourceName a name for the source (used in error messages)
 */
public record ParseOptions(
    ...
    /**
     * Returns default parse options with system locale, Iskara source type,
     * and a generic source name.
     */
