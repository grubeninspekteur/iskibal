 ...
 * Verifies that source code is correctly transformed into the AST model.
 */
class FullParseTest {
    ...
    class Imports {
        ...
        void parsesImportWithAliasAndType() {
            ...
            assertThat(module.imports().get(0))
                    .isEqualTo(new Import.Definition("Car", "org.acme.Car"));
        }
        ...
        void parsesMultipleImports() {
            ...
            assertThat(module.imports())
                    .containsExactly(
                            new Import.Definition("Car", "org.acme.Car"),
    ...
    class Facts {
        ...
        void parsesFactWithArrayType() {
            ...
            assertThat(module.facts().get(0))
                    .isEqualTo(new Fact.Definition("Item", "Item[]", null));
        }
    ...
    class Globals {
        ...
        void parsesGlobalWithQualifiedType() {
            ...
            assertThat(module.globals().get(0))
                    .isEqualTo(new Global.Definition("Clock", "java.time.Clock", null));
        }
    }
    ...
    class Outputs {
        ...
        void parsesOutputWithEmptyListInitialValue() {
            ...
            assertThat(output.initialValue())
                    .isInstanceOf(Expression.Literal.ListLiteral.class);
            assertThat(((Expression.Literal.ListLiteral) output.initialValue()).elements())
                    .isEmpty();
        }
        ...
        void parsesOutputWithoutInitialValue() {
            ...
            assertThat(module.outputs()).hasSize(1);
            assertThat(module.outputs().get(0))
                    .isEqualTo(new Output.Definition("Valid", "Boolean", null, null));
        }
    }
    ...
    class NavigationExpressions {
        ...
        void parsesChainedNavigation() {
            ...
            assertThat(binary.right())
                    .isEqualTo(new Expression.Literal.StringLiteral("Paris"));
        }
    }
    ...
    class MessageSendExpressions {
        ...
        void parsesKeywordMessageWithSinglePart() {
            ...
            assertThat(msg.parts().get(0).argument())
                    .isEqualTo(new Expression.Literal.StringLiteral("error message"));
        }
        ...
        void parsesKeywordMessageWithMultipleParts() {
            ...
            assertThat(rule.then()).singleElement()
                ...
                .isEqualTo(new MessageSend(
                    new Identifier("list"),
                    List.of(
                        new MessagePart("find", new NumberLiteral(BigDecimal.valueOf(5L))),
    ...
    class Literals {
        ...
        void parsesListLiteral() {
            ...
            assertThat(list.elements()).containsExactly(
                    new Expression.Literal.NumberLiteral(new BigDecimal("1")),
    ...
    class ParseOptions {
        ...
        void parsesWithLocale() {
            ...
            work.spell.iskibal.parser.api.ParseOptions options =
                    work.spell.iskibal.parser.api.ParseOptions.defaults().withLocale(Locale.US);
        ...
        void supportsIskaraSourceType() {
            assertThat(parser.supportedSourceTypes())
                    .contains(SourceType.ISKARA);
        }

        @Test
        void supportsAsciidocSourceType() {
            assertThat(parser.supportedSourceTypes())
                    .contains(SourceType.ASCIIDOC);
        }
    }
    ...
    private RuleModule parseSuccessfully(String input) {
        ...
        assertThat(result.isSuccess())
                .as("Parse should succeed but failed with: %s", result.getDiagnostics())
                .isTrue();
